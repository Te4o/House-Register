...
<center><fieldset class="head">
        ...
        <input type="Submit" class="btn btn-danger btn-lg" value="Discussions" onclick="window.location='GetAllDiscussionsServlet.jsp';">
	...
	<form action="AddDiscussionServlet" method="post">
		<center><h1><b>New Discussion</b></h1></center>
  		<h3><center><p><label class="field" for="Title">Title:</label><input type="text" name="title"/></p>
  		
  		<div class="form">
		<textarea name="content" rows="10" cols="30" ></textarea>
  		<p><input type="Submit" class="btn btn-danger btn-lg" value="Post Discussion"></p><center></h3>
</form>
</body>
</html>