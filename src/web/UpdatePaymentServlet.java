...
public class UpdatePaymentServlet extends HttpServlet {
	...
	//	int obligationId= Integer.valueOf(request.getParameter("obligationId"));
		
		//PaymentDAO pDAO = new PaymentDAO(getEntityManager());
		
		//pDAO.UpdatePayment(flatNumber, obligationId);
