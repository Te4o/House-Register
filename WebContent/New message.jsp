...
<center><fieldset class="head">
	...
	<center><fieldset class="book">
		...
		<center><h1><b>New Message</b></h1></center>
  		<h3><center><p><label class="field" for="Title">Title:</label><input type="text" name="title"/></p>
  		<p><label class="field" for="Send to">Send to:</label><input type="text" name="receiverNumber"/></p>

  		<div class="form">
		<textarea name="content" rows="10" cols="30" ></textarea>
		</div>
  		<p><input type="Submit" class="btn btn-danger btn-lg" value="Send"></p></h3>
	</fieldset></center>
	</form>
</body>
</html>